    ...
    <div className="home">
      ...
      <footer className="home-footer">
        <div className="home-footer__wr">
          <a href="/rules.html">правила</a> / <a href="/contacts.html">контакты</a> / <a href="/donate.html">пожертвования</a> / <a href="/d/">идеи и предложения</a>/ <a href="//t.me/hannel" target="blank">telegram канал</a>
        </div>
      </footer>
    </div>
  );
